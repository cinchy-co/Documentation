...
For more information, review the [Cinchy Event Broker/CDC Listener Configuration values here](cinchy-event-broker-cdc/), and then navigate to [the Listener Config table](../supported-real-time-sources/the-listener-configuration-table.md) to input a new row.
