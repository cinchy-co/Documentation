...
| Records Root JSONPath  | Mandatory. Specify the JSON path for the results. If the JSON response top-element is an object, entering `$.data` will refer to the parent object of the response, which will contain the object array. | `$.data`, `$`                                                                                     |
