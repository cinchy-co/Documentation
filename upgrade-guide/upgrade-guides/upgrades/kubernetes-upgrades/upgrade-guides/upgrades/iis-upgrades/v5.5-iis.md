...
{% hint style="danger" %}
<mark style="color:red;">**Warning:**</mark> This release requires you to run the Cinchy Upgrade Utility.[Please review and follow the directives for Upgrade 5.5 here.](https://app.gitbook.com/o/-LDtM6UlhGoQ91uwM5SF/s/F1vvLbEMfTF1UqCFU9hs/\~/changes/287/upgrade-guide/upgrade-guides/upgrades/cinchy-upgrade-utility)
