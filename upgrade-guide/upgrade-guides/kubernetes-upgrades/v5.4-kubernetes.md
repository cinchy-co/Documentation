...
1. Turn off your Cinchy platform. In a Kubernetes deployment,[ you can do so via ArgoCD.](../../../deployment-guides/kubernetes/disabling-your-kubernetes-applications.md)
...
1. Turn your platform back on. In a Kubernetes deployment, [you can do so via Argo CD](../../../deployment-guides/kubernetes/disabling-your-kubernetes-applications.md#2.-re-enabling-your-applications)
