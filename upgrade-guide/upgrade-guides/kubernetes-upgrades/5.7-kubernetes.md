...
If you are upgrading from Cinchy v5.1 or lower to Cinchy v5.7, you must run **Upgrade 5.2** [using the Cinchy Utility](../upgrades/cinchy-upgrade-utility.md) and deploy version 5.2.
...
If you are upgrading from Cinchy v5.4 or lower to Cinchy v5.7, you must run **Upgrade 5.5** using [the Cinchy Utility](../upgrades/cinchy-upgrade-utility.md) and deploy version 5.5.
