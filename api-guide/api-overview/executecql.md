...
| Type           | string    | <br/> QUERY- Query (Approved Data Only) <br/> DRAFT_QUERY- Query (Include Draft Changes) <br/>SCALAR- Scalar <br/>NONQUERY- Non Query, such as an insert or delete <br/> VERSION_HISTORY_QUERY- Query (Include Version History) |
| ConnectionId   | string    |
