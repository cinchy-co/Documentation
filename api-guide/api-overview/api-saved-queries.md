...
![Image 2: Using API Saved Queries](<../../.gitbook/assets/image (600).png>)
...
![Image 3: The Entitlements Table](<../../.gitbook/assets/image (709).png>)
...
![Image 4: Design your Query](<../../.gitbook/assets/image (591).png>)
...
![Image 5: Change your API Result Format to JSON](<../../.gitbook/assets/image (65).png>)
...
![Image 6: Ensuring the anonymous user has access](<../../.gitbook/assets/image (586).png>)

9\. Navigate to **"Execute Query"** from the left navigation bar.

10\. Copy your **REST API endpoint URL** _(Image 7)._

![Image 7: Copy your REST API endpoint URL](<../../.gitbook/assets/image (325).png>)
...
![Image 8: Testing your API](<../../.gitbook/assets/image (488).png>)
