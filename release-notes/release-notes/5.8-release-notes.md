...
- **Retrying After Failure**: You can now set **Active** to **Yes** to prompt the listener to retry.
- **System Failures**: Cinchy now handles failures and updates of the real-time operational state more accurately.
