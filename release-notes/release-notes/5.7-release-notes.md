...
```
#### Faster query performance for Postgres multi-select column joins

We optimized query speeds for Postgres users, specifically when joining a multi-select column to its parent table.
### Meta-Forms
