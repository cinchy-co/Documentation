...
We've improved our variable system to boost clarity and reduce errors. Previously known as Parameters, the new design introduces three distinct variable types: Text, Formula, and Secret.

Text Variables: This is the default type, and behaves the same way variables did before this update.

Formula Variables: To minimize typos and related errors when entering formula names, these variables auto suggest formula names and provide input fields for the expected values.

Secret Variables: When you choose this variable, you'll get a dropdown menu listing all the Secrets you're permitted to access.

You can integrate these variables the same way as before, by prefixing their assigned labels, such as `@myVariableLabel`.
