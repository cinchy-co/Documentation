...
* We have fixed a bug where using the "Delta" sync strategy led to duplicating existing records in some destinations before inserting the new rows of data.
