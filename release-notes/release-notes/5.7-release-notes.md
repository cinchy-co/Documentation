...
Additional system columns were added in order to extend the number of core Cinchy objects that can be managed through [DXD](../../guides-for-using-cinchy/builder-guides/cinchydxd-utility/) 1.7 and higher.&#x20;
...
* We fixed an issue where the first load of an applet wouldn't render sections that require Cinchy data. 
