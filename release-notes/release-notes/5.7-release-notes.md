...
{% hint style="info" %}
For instructions on how to upgrade your platform to the latest version, please review the documentation [here.](../../upgrade-guide/upgrade-guides/README.md)
...
![Forms new dropdown menu](<../../.gitbook/assets/Forms/Meta-Forms - Menu.png>)
