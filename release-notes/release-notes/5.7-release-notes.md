...
* We fixed an issue with the behaviour of calculated columns when using data types with multiple selections (Link, Choice, and Hierarchy). These data types should now act as expected.
