...
## Create a table from scratch <a href="#standard-vs-spatial-table" id="standard-vs-spatial-table"></a>
...
![Image 1: Step 1, Getting Started](<../../../.gitbook/assets/image (764).png>)
...
![Image 2: Step 2, select either a Standard or Spatial Table](<../../../.gitbook/assets/image (602).png>)

3. Select **From Scratch** _(Image 3)_.

![Image 3: Step 3, Select "From Scratch"](<../../../.gitbook/assets/image (239).png>)
...
![Image 4: Step 4, Adding table info.](<../../../.gitbook/assets/image (26).png>)
...
![Image 5: Step 5, Selecting the Columns tab](<../../../.gitbook/assets/image (624).png>)
...
![Image 6: Step 6, defining your column ](<../../../.gitbook/assets/image (42).png>)
...
![Image 7: Step 7, setting your permissions](<../../../.gitbook/assets/image (386).png>)

8. Click **Save** to finalize your table.

9. You may return to change the structure of the existing table (such as rename columns, add new columns, change data type) by clicking on the **Design Table** button on the left-hand navigation _(Image 8)._

![Image 8: Step 9, changing an existing table structure](<../../../.gitbook/assets/image (87).png>)

## Import a CSV to create a table <a href="#import-a-csv" id="import-a-csv"></a>
...
![Image 9: Step 1, Getting Started](<../../../.gitbook/assets/image (764).png>)
...
![Image 10: Step 2, select either a Standard or Spatial Table](<../../../.gitbook/assets/image (602).png>)

3. Select **Import a CSV** _(Image 11)_.

![Image 11: Step 3, Select "Import a CSV"](<../../../.gitbook/assets/image (239).png>)
...
5. When creating a table via Import a CSV, some settings will be set by default:
...
![Image 12: Step 6, Design Table tab](<../../../.gitbook/assets/image (137).png>)

## Table views <a href="#default-view" id="default-view"></a>
...
1. When you first create a table, a default view called **All Data** will be created for you, which you can find on the left navigation bar under **Manage Data** _(Image 13)._

![Image 13: Step 1: The All Data view](<../../../.gitbook/assets/image (584).png>)

2. You can create additional views by clicking on **"+Create View"** (_Image 14)._

![Image 14: Step 2, Select "Create View"](<../../../.gitbook/assets/image (156).png>)

3. You may chose to create a view **From Scratch** or by **Copying an Existing** view _(Image 15)._

![Image 15: Step 3, Creating a View](<../../../.gitbook/assets/image (116).png>)
...
![Image 17: Step 4, Selecting Columns](<../../../.gitbook/assets/image (497).png>)

5\. Click on the **Sort tab** in the left navigation bar _(Image 18)._

![Image 18: Step 5, Sorting](<../../../.gitbook/assets/image (312).png>)
...
![Image 19: Step 6, Sorting your view](<../../../.gitbook/assets/image (109).png>)
...
8\. Click on the **Permission tab** in the left navigation bar. Here, you may set permissions for who can use this view. By default, it's set to **All Users** _(Image 21)._

![Image 21: Step 8, setting permissions.](<../../../.gitbook/assets/image (23).png>)
...
![Image 22: Step 2, Importing a view](<../../../.gitbook/assets/image (242).png>)
...
![Image 23: Step 1, Updating a View](<../../../.gitbook/assets/image (71).png>)
