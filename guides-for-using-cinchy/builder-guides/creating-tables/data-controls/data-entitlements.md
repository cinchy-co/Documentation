...
3. In the above scenario, John Smith is part of the **Developers group**. They're able to view all columns via the entitlement to the **Developers group**, and they're able to edit both the First Name and Last Name column through different entitlements.
...
### Viewable & Editable Row Filter <a href="#viewable-and-editable-row-filter" id="viewable-and-editable-row-filter"></a>
...
### Examples for Row Filter <a href="#examples-for-row-filter" id="examples-for-row-filter"></a>
