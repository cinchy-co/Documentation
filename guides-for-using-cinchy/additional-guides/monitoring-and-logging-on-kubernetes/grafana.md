...
- [Exploring your Metrics](https://grafana.com/tutorials/grafana-fundamentals/?utm_source=grafana_gettingstarted#explore-your-metrics)
- [Best Practices for Creating Dashboards](https://grafana.com/docs/grafana/latest/best-practices/best-practices-for-creating-dashboards/)
- [Building a Dashboard](https://grafana.com/tutorials/grafana-fundamentals/?utm_source=grafana_gettingstarted#build-a-dashboard)
...
You can use the following example queries to set up a dashboard that will capture the CPU I/O wait _(Image 19)._
...
5. If your environment isn't set-up to automatically apply upon configuration,navigate to the **ArgoCD** portal and refresh your component(s). If that doesn't work, **re-sync.**
