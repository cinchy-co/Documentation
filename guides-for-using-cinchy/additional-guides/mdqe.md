...
| **Send Notifications** | <p>Choose from the drop down list. Use “Never” if you don't want email notifications sent out.<br><br><em>Example: Daily</em><br><br><strong>Note : In case you would like to define your own Notification frequency, use [Cinchy MDQE].[Notification schedule] table. You would need admin privileges to view this table</strong></p> |
