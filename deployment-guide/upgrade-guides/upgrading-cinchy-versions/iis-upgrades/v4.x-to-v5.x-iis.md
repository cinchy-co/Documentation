...
{% hint style="danger" %}
<mark style="color:red;">**Warning:**</mark> If you are upgrading from Cinchy v5.1 or lower to Cinchy v5.2** or higher, please see the [Cinchy Upgrade Utility](../../../upgrade-guides/upgrading-cinchy-versions/cinchy-upgrade-utility.md) and follow the directives on that page. This process can be run when upgrading your IIS v4 instance to any v5+ instance
{% endhint %}
